...
export const SettingMenuItem = ({ data }: { data: T_SettingMenuItem }) => {
  ...
  return (
    <div className="w-full px-4 py-2 cursor-pointer transition-colors duration-300 text-indigo-900 hover:bg-slate-400 text-md hover:text-indigo-700 flex gap-2 items-center">
